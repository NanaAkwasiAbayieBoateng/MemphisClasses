...
polarboxmuller <- function(x0,y0, B, m, n,c){

u1 = LCG_u_seq(x0, B, m, n,c)
u2= LCG_u_seq(y0, B, m, n,c) 
...
r2=v1^2+v2^2   
   ...
   x1[i] =v1[i]*sqrt((-2*log(r2[i]))/r2[i])
  x2[i] = v2[i]*sqrt((-2*log(r2[i]))/r2[i])
