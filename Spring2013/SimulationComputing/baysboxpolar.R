...
Bays_Durham<-function(k,x0, B, m, n,c)
{

LL <- LCG_seq(x0, B, m, n,c)
...
#boxmuller=function(k,x0,B,m,n,c){
...
#}
boxmuller(8,101,1221, 2048, 2000,1)
